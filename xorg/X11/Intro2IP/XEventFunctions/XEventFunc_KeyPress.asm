...
;   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    mov    ebx, [is_ImageFilter_blocked]
...
KeyPress_is_Q:
    cmp    ebx, _TRUE_
    je     KeyPress_not_Q ;skip SSE2_ImageFilter_NoFilter()
...
KeyPress_is_W:
    cmp    ebx, _TRUE_
    je     KeyPress_not_W ;skip SSE2_ImageFilter_Mean()
...
KeyPress_is_E:
    cmp    ebx, _TRUE_
    je     KeyPress_not_E ;skip SSE2_ImageFilter_EDGradient()
    jmp    SSE2_ImageFilter_EDGradient
KeyPress_not_E:
